 ...
 * literal space is the only trick that works across both (SSML / phoneme markup
 * support is uneven). The notification body keeps the unbroken spelling — only
 * the spoken path goes through this transform.
 */
